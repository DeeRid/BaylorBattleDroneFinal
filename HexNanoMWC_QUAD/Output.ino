...
void writeMotors() { // [1000;2000] => [125;250]
  ...
  /******** Specific PWM Timers & Registers for the atmega32u4 (Promicro)   ************/
      ...
      #else
      if(propellerMode == 0  || propellerMode ==2) 
        OCR1A = ((motor[0]<<4) - 16000) + 128;   // Rear-Right   All,Two
      #endif
    #endif
    #if (NUMBER_MOTOR > 1)
      #ifndef EXT_MOTOR_RANGE 
      ...
      #else
      if(propellerMode == 0)
        OCR1B = ((motor[1]<<4) - 16000) + 128;  //Front-Right All
      #endif
    #endif
        ...
        #else
        if(propellerMode == 0 || propellerMode == 3)
          OCR3A = ((motor[2]<<4) - 16000) + 128;  //Rear-Left  All,Three
        #endif
      #endif
    #endif
    #if (NUMBER_MOTOR > 3)
      ...
      #else
        TC4H = (((motor[3]-1000)<<1)+16)>>8; OCR4D = ((((motor[3]-1000)<<1)+16)&0xFF); //  pin 6  Front-Left  Always
      #endif
    #endif    
    #if (NUMBER_MOTOR > 4)
      #if !defined(HWPWM6)
        ...
        #else
        if(propellerMode == 0 || propellerMode == 3)
           OCR1C = ((motor[4]<<4) - 16000) + 128;  //Right All,Three
        if(propellerMode == 0){   
           TC4H = (((motor[5]-1000)<<1)+16)>>8; OCR4A = ((((motor[5]-1000)<<1)+16)&0xFF); //  pin 13 Left All 
        }   
        #endif  
      #endif
    #endif
