...
#define IR_SENSOR                 pinMode(38,INPUT);   //Set Sensor As Input

#define RGY_RED                   pinMode(28,OUTPUT); //Set GREEN LED Pin
#define RGY_RED_ON                PORTB |= (1<<4);    //Set GREEN ON
#define RGY_RED_OFF               PORTB &= ~(1<<4);   //Set GREEN OFF
                  
#define RGY_GRN                   pinMode(26,OUTPUT); //Set YELLOW LED Pin
#define RGY_GRN_ON                PORTD |= (1<<6);    //Set YELLOW ON
#define RGY_GRN_OFF               PORTD &= ~(1<<6);   //Set YELLOW OFF

#define RGY_YLW                   pinMode(26,OUTPUT); //Set RED LED Pin
#define RGY_YLW_ON                PORTD |= (1<<4);    //Set RED ON
#define RGY_YLW_OFF               PORTD &= ~(1<<4);   //Set RED OFF
